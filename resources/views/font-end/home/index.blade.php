        ...
        <div class="single-slider">
					<div class="container">
						<div class="row">
							<div class="col-lg-6 ">
								<div class="text">
									<h1>My Name <span>Medical</span> Services That You Can <span>Trust!</span></h1>
									<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris sed nisl pellentesque, faucibus libero eu, gravida quam. </p>
									<div class="button">
										<a href="#" class="btn">Hire Me</a>
										<a href="#" class="btn primary">Learn More about me</a>
									</div>
								</div>
							</div>
                            <div class="col-lg-6" style="background-image:url(assets/img/my-bg.png)">
                                <div class="image">
